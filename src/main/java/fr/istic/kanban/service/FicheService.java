...
public class FicheService {
	...
	/*
	 * Recup�rer une valeur � partir d'un id NotFundException
	 */
	...
	/*
	 * Recup�rer une valeur � partir d'un id NotFundException if id is'nt valid
	 * or not found
	 */
	...
	/*
	 * Supprimer une entit� NotFundException if id is'nt valid or not found
	 */
	...
	/*
	 * R�cup�rer la liste des tags � partir d'un id de fiche
	 */
